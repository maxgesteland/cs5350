...
class NN:
    def __init__(self, input_size, hidden1_size, hidden2_size, output_size=1):
        self.W1 = [[0.0 for _ in range(input_size+1)] for _ in range(hidden1_size)]
        self.W2 = [[0.0 for _ in range(hidden1_size+1)] for _ in range(hidden2_size)]
        self.W3 = [[0.0 for _ in range(hidden2_size+1)] for _ in range(output_size)]
